...
#ifndef RAPTORUPLOADEDSUITE_H
#define RAPTORUPLOADEDSUITE_H
...
class RaptorUploadedSuite Q_DECL_FINAL : public QObject
{
    Q_OBJECT
...
public:
    ...
    static RaptorUploadedSuite* invokeSingletonGet();
