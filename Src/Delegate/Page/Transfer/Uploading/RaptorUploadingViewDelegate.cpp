...
#include "RaptorUploadingViewDelegate.h"

void RaptorUploadingViewDelegate::paint(QPainter* qPainter,
                                        ...
                                        const QModelIndex& qIndex) const
{
    ...
    else if (qColumn == 3)
    {
        ...
        // 网速、剩余传输时间绘制
        qPainter->save();
        auto qStatusTextOption = QTextOption();
        qStatusTextOption.setAlignment(Qt::AlignLeft | Qt::AlignVCenter);
