...
#ifndef RAPTORUPLOADINGVIEWDELEGATE_H
#define RAPTORUPLOADINGVIEWDELEGATE_H
...
class RaptorUploadingViewDelegate Q_DECL_FINAL : public QStyledItemDelegate
{
    Q_OBJECT
...
#endif // RAPTORUPLOADINGVIEWDELEGATE_H