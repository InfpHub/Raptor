...
#ifndef RAPTORUPLOADEDVIEWMODEL_H
#define RAPTORUPLOADEDVIEWMODEL_H

#include <QAbstractTableModel>

#include "../../../../Common/RaptorDeclare.h"

class RaptorUploadedViewModel Q_DECL_FINAL : public QAbstractTableModel
{
    Q_OBJECT
...
#endif // RAPTORUPLOADEDVIEWMODEL_H