...
#ifndef RAPTORDOWNLOADEDVIEWMODEL_H
#define RAPTORDOWNLOADEDVIEWMODEL_H

#include <QAbstractTableModel>

#include "../../../../Common/RaptorDeclare.h"

class RaptorDownloadedViewModel Q_DECL_FINAL : public QAbstractTableModel
{
    Q_OBJECT
...
#endif // RAPTORDOWNLOADEDVIEWMODEL_H