...
#ifndef RAPTORDOWNLOADINGVIEWMODEL_H
#define RAPTORDOWNLOADINGVIEWMODEL_H
...
class RaptorDownloadingViewModel Q_DECL_FINAL : public QAbstractTableModel
{
    Q_OBJECT
...
#endif // RAPTORDOWNLOADINGVIEWMODEL_H