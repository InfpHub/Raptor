...
#ifndef RAPTORUPLOADVIEWMODEL_H
#define RAPTORUPLOADVIEWMODEL_H
...
class RaptorUploadViewModel Q_DECL_FINAL : public QAbstractTableModel
{
    Q_OBJECT
