...
#ifndef RAPTORPLAYPAGE_H
#define RAPTORPLAYPAGE_H
...
namespace Ui
{
    class RaptorPlayPage;
}

QT_END_NAMESPACE

class RaptorPlayPage Q_DECL_FINAL : public QWidget
{
    Q_OBJECT

public:
    explicit RaptorPlayPage(QWidget* qParent = Q_NULLPTR);

    ~RaptorPlayPage() Q_DECL_OVERRIDE;
...
private:
    Ui::RaptorPlayPage* _Ui = Q_NULLPTR;
